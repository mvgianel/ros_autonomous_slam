...
// generate the same numbers as in the original C test program
  ...
  nh->declare_parameter(ns.append("/eta"), 0.5);
  nh->declare_parameter(ns.append("/map_topic"), "/map");
  nh->declare_parameter(ns.append("/robot_frame"), "/base_link");

  nh->get_parameter("eta", eta);
  nh->get_parameter(ns.append("/map_topic"), map_topic);
  nh->get_parameter(ns.append("/robot_frame"), base_frame_topic);
...
auto pub = nh->create_publisher<visualization_msgs::msg::Marker>(ns.append("_shapes"), 10);
