...
def generate_launch_description():
        ...
        RRT_global_detect =  Node(
                ...
                parameters=[{'geta': LaunchConfiguration('geta')},{'map_topic': '/map'}, {'base_frame_topic': '/base_link'}],
                output='screen')
        ...
        RRT_local_detect = Node(
                ...
                name='local_detector',
                parameters=[{'eta': LaunchConfiguration('eta')},{'map_topic': '/map'}, {'base_frame_topic': '/base_link'}],
                output='screen')
        ...
        frontier_RRT = Node(
                package = 'ros_autonomous_slam',
                executable= 'frontier_opencv_detector.py',
                name = 'assigner',
